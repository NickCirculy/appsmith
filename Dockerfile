...
# Add bootstrapfile
COPY ./deploy/docker/entrypoint.sh ./deploy/docker/scripts/* ./deploy/docker/start_backend.sh ./
...
RUN chmod +x entrypoint.sh renew-certificate.sh healthcheck.sh start_backend.sh
